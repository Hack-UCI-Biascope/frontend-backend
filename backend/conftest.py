...
@pytest.fixture
def user_token_headers(client: TestClient, test_user, test_password, monkeypatch) -> Dict[str, str]:
...
@pytest.fixture
def superuser_token_headers(client: TestClient, test_superuser, test_password, monkeypatch) -> Dict[str, str]:
    monkeypatch.setattr(security, "verify_password", verify_password_mock)
